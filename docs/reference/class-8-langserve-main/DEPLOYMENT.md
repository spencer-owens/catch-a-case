...
## NOTES
The following instructions are for the root directory for setup and local execution of the app we deploy to Render in class. For the demo directory instructions, see the [MAIN README](./README.md).
